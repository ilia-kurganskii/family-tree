...
export function addNewNodes(
  ...
  nodeBlock
    ...
    .append('span')
    .attr('class', 'tui-island__paragraph')
  ...
  const secondParent = nodeBlock
    ...
    .append('div')
    .attr('class', 'node__second');

  secondParent
    .append('span')
    .attr('class', 'node__second__title')
    .text((d) => d.data.secondParent?.firstname ?? '');

  secondParent
    .filter((d) => !!d.data.secondParent?.description)
    .append('span')
    .attr('class', 'node__second__text')
